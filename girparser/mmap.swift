...
/// mapped file
///
func with_mmap(file: String, protection: Int32 = PROT_READ, flags: Int32 = MAP_PRIVATE, process: (UnsafeMutablePointer<Void>, Int) -> Void) {
    ...
    let mem = mmap(nil, len, protection, flags, fn, 0)
    guard mem != nil && mem != UnsafeMutablePointer(bitPattern: -1) else {
...
/// mapped file
///
func with_mmap<Element>(file: String, protection p: Int32 = PROT_READ, flags f: Int32 = MAP_PRIVATE, process: UnsafeBufferPointer<Element> -> Void) {
